...
export const codes = [
    {
        fileName: "Swap.sol",
        code: "",
    },
    {
        fileName: "SwapExampleInputs.sol",
        code: "",
    },
]
...
<p><em>exact-input</em>: <code>amountSpecified</code> is negative -- users provide an exact amount of input tokens</p>
<p><em>exact-output</em>: <code>amountSpecified</code> is positive -- users <strong>expect</strong> an exact amount of output tokens</p>
...
<span class="hljs-class"><span class="hljs-keyword">contract</span> <span class="hljs-title">Swap</span> </span>{
    ...
    <span class="hljs-keyword">uint160</span> <span class="hljs-keyword">public</span> <span class="hljs-keyword">constant</span> MIN_PRICE_LIMIT <span class="hljs-operator">=</span> TickMath.MIN_SQRT_PRICE <span class="hljs-operator">+</span> <span class="hljs-number">1</span>;
    <span class="hljs-keyword">uint160</span> <span class="hljs-keyword">public</span> <span class="hljs-keyword">constant</span> MAX_PRICE_LIMIT <span class="hljs-operator">=</span> TickMath.MAX_SQRT_PRICE <span class="hljs-operator">-</span> <span class="hljs-number">1</span>;
    ...
    <span class="hljs-comment">/// @param amountSpecified the amount of tokens to swap. Negative is an exact-input swap</span>
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">swap</span>(<span class="hljs-params">PoolKey <span class="hljs-keyword">memory</span> key, <span class="hljs-keyword">int256</span> amountSpecified, <span class="hljs-keyword">bool</span> zeroForOne, <span class="hljs-keyword">bytes</span> <span class="hljs-keyword">memory</span> hookData</span>) <span class="hljs-title"><span class="hljs-keyword">internal</span></span> </span>{
        ...
        <span class="hljs-comment">// in v4, users have the option to receieve native ERC20s or wrapped ERC6909 tokens</span>
        ...
        PoolSwapTest.TestSettings <span class="hljs-keyword">memory</span> testSettings <span class="hljs-operator">=</span>
            PoolSwapTest.TestSettings({takeClaims: <span class="hljs-literal">false</span>, settleUsingBurn: <span class="hljs-literal">false</span>});
...
<span class="hljs-comment">// Swap exactly 1e18 of token0 into token1</span>
<span class="hljs-comment">// ---------------------------- //</span>
